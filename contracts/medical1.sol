...
contract hospital1{
    ...
    function ret_name(address _paId) public view returns(string memory _paName){
        _paName = PatientInfo[_paId].pa_Name;
    }

    function ret_records(address _paId) public view returns(string[] memory _paRecords){
        _paRecords = PatientInfo[_paId].pa_Records;
    }
